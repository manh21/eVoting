...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => '../assets/uploads/',                 // path to files (REQUIRED)
			'tmbPath'       => '../assets/uploads/tmb/',
			'tmbURL'     	=> dirname($_SERVER['PHP_SELF']) . '/../assets/uploads/tmb',
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/../assets/uploads/', // URL to files (REQUIRED)
		...
		array(
			...
			'driver'        => 'Trash',
			'path'          => '../files/.trash/',
			'tmbURL'        => dirname($_SERVER['PHP_SELF']) . '/../assets/uploads/.trash/.tmb/',
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too

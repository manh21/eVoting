...
class Kelas extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['site_url'] = site_url() . '/admin/kelas/index?q=' . urlencode($q);
            $config['first_url'] = site_url() . '/admin/kelas/index?q=' . urlencode($q);
        } else {
            $config['site_url'] = site_url() . '/admin/kelas/index';
            $config['first_url'] = site_url() . '/admin/kelas/index';
        }
